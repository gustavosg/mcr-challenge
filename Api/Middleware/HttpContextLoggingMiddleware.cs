...
namespace Api.Middleware
{
    public class HttpContextLoggingMiddleware
    {
        ...
        public HttpContextLoggingMiddleware(RequestDelegate next, ILoggerFactory loggerFactory)
        {
            this.next = next;
            this.logger = loggerFactory.CreateLogger<HttpContextLoggingMiddleware>();
